...
Repositorio de directorio = BD con los objetos.
Servicio de directorio = Gestiona el repositorio de directorio y sus objetos.

Principales servicios de Directorio:

1. Active Directory: Servicio de Windows
2. Open Directory: Servicio de Mac OS X
3. Servidor de Directorio de Apache: Servicio de Apache Software Fundation
